...
encodings are: C<j> or C<json>, C<hex>, C<base64>, C<e> or C<expr>.
...
=item * directive lines (C<;!directive>) for extra features, including: merging between sections,
